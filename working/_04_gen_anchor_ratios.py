...
if __name__=='__main__':
    ...
    parser.add_argument('-d', '--data_path', type=str, default='data/PnID', help='target data root path')
    ...
    INSTANCES_PATH = f'{args.data_path}/{project_name}_resize/annotations/instances_train.json'
    instances={}
